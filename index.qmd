...
TMB does seem to differ significantly between the different tumor locations. Distant tumors seem to have higher mutational burden than the lymph node samples, see @fig-tmb-loc for a plot of the three locations and t-tests between the groups (treated as unpaired data).
