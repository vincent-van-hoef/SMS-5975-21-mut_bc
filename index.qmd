...
205 samples are included in this study. [The sample table contains 207 entries, but 2 samples were not sequenced.]{.aside} sample 11, 12 and 19 are corrupted and were removed because they cause the analysis pipeline to stop in error. Requested acces to the original files through Celemics but so far they have not sent over the intact files.
...
add ER mutation data...

## Nanostring data

Link Nanostring data to lymph node status...
